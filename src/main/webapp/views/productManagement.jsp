	...
	<section class="container">
		...
		<form method="post" action="add" class="form-horizontal">
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<div class="form:input-prepend">
							<input name="price" type="text" required class="form:input-large" />
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<label class="control-label col-lg-2" for="productType">Product
						Type:</label>
					<div class="col-lg-10">
									...
									<div class="caption">
										...
										<p>
											...
											<a
												...
												onclick="return confirm('Are you sure, U want to Remove this product?')">

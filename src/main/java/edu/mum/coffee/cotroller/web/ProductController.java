...
public class ProductController {
	...
	/*
	 * @RequestMapping("*") public String adda() { return "redirect:/products"; }
	 */
	...
	/**
	 * getAllproducts: from RESTful service
	 * 
	 * @param model
	 * @return
	 */
	...
	public String getAllproducts(Model model) {
		...
		String uri = "http://localhost:8080/pro/products";
		List<Product> products = ord.getForObject(uri, ArrayList.class);
	...
	public String deleteAproduct(@RequestParam("id") int id, Model model) {
	 ...
	 * String update(Product product, @PathVariable int id) {
	 * products.save(product); // product.id already set by binding return
	 * "redirect:/products"; }
	 */
